          ...
          <div class="row gutters">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="form-group">
                ...
                <input type="name" class="form-control" id="jabatan" placeholder="Enter jabatan" value="" disabled>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="form-group">
                <label for="Level">Level</label>
                <input type="name" class="form-control" id="Level" placeholder="Enter Level" value="" disabled>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="form-group">
                <label for="Department">Department</label>
                <input type="text" class="form-control" id="Department" placeholder="Enter Department" value="" disabled>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="form-group">
                <label for="sd">Sub Department</label>
                <input type="text" class="form-control" id="sd" placeholder="sd Code" value="" disabled>
              </div>
            </div>
          </div>
        </div>
